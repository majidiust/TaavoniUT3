...
{
	window.location = "SeminarInfo.html?WebinarID=" + webinarID;
}
        			...
        			success:function (result) {
            			if (result.Status == true) 
						{
							if(result.Result.Exist == true)
							{
								...
								_message = "شما قبلا برای این وبینار درخواست داده اید و کد رهگیری شما " + result.Result.Code + " است.";
